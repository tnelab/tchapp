...
macro(SET_CEF_TARGET_OUT_DIR)
  if(${CMAKE_GENERATOR} STREQUAL "Ninja" OR
	...
	#zmg
	set(CEF_TARGET_OUT_DIR "${PUBLISH_DIR}/linux/${PROJECT_ARCH}/${CMAKE_BUILD_TYPE}")
	#zmg end
...
macro(SET_COMMON_TARGET_PROPERTIES target)
  ...
  # Include directories.
  target_include_directories(${target} PUBLIC ${CEF_INCLUDE_PATH} ${CMAKE_CURRENT_SOURCE_DIR}/..)
